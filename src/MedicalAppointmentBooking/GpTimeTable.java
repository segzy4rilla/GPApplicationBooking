...
import static MedicalAppointmentBooking.AppointmentDate.conn;

/**
 *
 * @author Godwinstuff
 */
public class GpTimeTable {
    ...
    GpTimeTable(String[] Jul, String[] Seven, String[] Simran, String[] Zazu, String[] Amie, String[] hel,
    ...
    public void makeframe() {
        ...
        back.addActionListener((ActionEvent e) -> {
            AppointmentDate tab = new AppointmentDate(PatientName);
            tableframe.dispose();
